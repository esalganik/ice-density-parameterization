function make_si_ridge_density_figure(repoRoot)
...
is_fyi = ice_type == "FYI" & ~is_svalbard & ~is_freeze;
is_old = ice_type ~= "FYI" & ~is_svalbard & ~is_freeze;
is_sva = is_svalbard & ~is_freeze;
