function make_figureS1_mosaic_coring_density_figure(repoRoot)
%
% MAKE_MOSAIC_CORING_DENSITY_FIGURE
%
% Generates Supporting Figure S1 from MOSAiC coring freeboard data.
%
% The script estimates effective sea-ice density hydrostatically from
% measured ice thickness, ice draft, snow thickness, seawater density, and
% seasonal snow density.
%
% Input:
%   data/raw/MOSAiC_coring_freeboards.xlsx
%
% Output:
%   figures/FigS1.png
%
...
for s = 1:numel(sheets)
    ...
    % Each core event is stored as a thickness/draft column pair.
    thickCols = 1:2:nCols;
    draftCols = 2:2:nCols;
...
% Rearranged hydrostatic balance used to infer effective sea-ice density from measured ice draft, ice thickness, snow thickness, and snow density.
...
% Remove physically implausible hydrostatic density estimates before calculating summary statistics and plotting.
...
% Split observations before and after 1 July to highlight the summer density reduction during late MOSAiC.
...
% Convert Excel cell values to numeric values.
...
% Convert Excel date representations to MATLAB datetime values.
...
% Estimate kernel density for plotting density distributions.
